...
const NAV_ITEMS: { id: AppView; label: string; icon: typeof IconPlus }[] = [
  { id: "project", label: "Project", icon: IconSearch },
  { id: "general-chat", label: "Web chat", icon: IconPlus },
  { id: "account-settings", label: "Account", icon: IconSettings },
];
